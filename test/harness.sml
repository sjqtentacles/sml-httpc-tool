(* harness.sml -- a tiny, dependency-free test harness shared across the
   sjqtentacles libraries. Output is plain text and identical across compilers,
   so MLton and Poly/ML runs can be diffed directly. *)
structure Harness :>
sig
